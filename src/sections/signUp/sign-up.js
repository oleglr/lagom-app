        ...
        <Flex>
          <HeaderWrapper column>
            ...
            <Text style={{ margin: '16px 0', textAlign: 'left' }}>
              A small group based social media, connect with family and close
              friends. Imagine a whatsapp group with features such as photo
              albums, plan group activities, split bills.
            </Text>
            <Flex justify="unset">
              <Button
